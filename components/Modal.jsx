...
const Modal = ({showModal, setShowModal, title, location, cart, img, pic, users, criteria, setCriteria, client, setClient, clientSecret, newSale, setNewSale, product, options, stripePromise, shipping, amount, paymentIntent, quantity}) => {
      ...
      <>
          {showModal &&
                <div className={styles.container} >
                    {title === 'Nieuw' && <NieuwModal handleClick={handleClick}/>}
                    ...
                    {title === 'Cart' && <CartSummary quantity={quantity} showModal={showModal} setShowModal={setShowModal} product={product} img={img}/>}
