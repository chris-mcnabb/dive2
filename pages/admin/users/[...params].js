                    ...
                    <div className={styles.infoContainer}>
                       ...
                       <div className={section === 'Personal' ? styles.infoActive : styles.info}>
                           ...
                           <div  className={editInput === 'username' ? styles.live : styles.notLive}>
                               <span className={styles.span}><input  type="text" placeholder='new username...'/></span><span className={styles.check}><CheckCircle/></span>
                           </div>
                           ...
                           <div  className={editInput === 'address' ? styles.live : styles.notLive}>
                               <span className={styles.span}><input  type="text" placeholder='new address...'/></span><span className={styles.check}><CheckCircle/></span>
                           </div>
                           <hr className={styles.hr}/>
                           <div className={styles.containerItem}>
                               <div>
                           ...
                           <div  className={editInput === 'city' ? styles.live : styles.notLive}>
                               <span className={styles.span}><input  type="text" placeholder='new city...'/></span><span className={styles.check}><CheckCircle/></span>
                               <span className={styles.span}><input  type="text" placeholder='new postal code...'/></span><span className={styles.check}><CheckCircle/></span>
                           </div>
                           <hr className={styles.hr}/>
                            <span className={styles.span}>
