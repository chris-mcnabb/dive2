            ...
            <div className={styles.header}>
                    ...
                    <div className={styles.headerSearch}>
                        <div className={styles.headerSearchItem}>
                            <FontAwesomeIcon icon={faMask} className={styles.headerIcon}/>
                            <input type="text" placeholder='What do you want to rent:' className={styles.headerSearchInput}/>
                        ...
                        <div className={styles.headerSearchItem}>
                            <FontAwesomeIcon icon={faCircleHalfStroke} className={styles.headerIcon}/>
                           <span>how long</span>
